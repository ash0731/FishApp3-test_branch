...
//            dbLoader = new DBLoader(com.cvsu.ash.rhea.fishapp.MapsActivity.this);
...
//        }
//
//        public void animateToLocation(double lat, double lng, String street, String facility) {
//            mMap.clear();
//            String f = facility;
//            String s = street;
...
//                    com.cvsu.ash.rhea.fishapp.MapsActivity.DownloadTask downloadTask = new com.cvsu.ash.rhea.fishapp.MapsActivity.DownloadTask();
...
//            ProgressDialog progressDialog = new ProgressDialog(com.cvsu.ash.rhea.fishapp.MapsActivity.this);
//
//            @Override
...
//
//                com.cvsu.ash.rhea.fishapp.MapsActivity.ParserTask parserTask = new com.cvsu.ash.rhea.fishapp.MapsActivity.ParserTask();
...
//                            LayoutInflater inflater = (LayoutInflater) com.cvsu.ash.rhea.fishapp.MapsActivity.this.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
//                            View promptsView = inflater.inflate(R.layout.text_directions_container, null);
//                            AlertDialog.Builder alerDialog = new AlertDialog.Builder(com.cvsu.ash.rhea.fishapp.MapsActivity.this);
...
//                            TextDirectionsRecyclerView adapter = new TextDirectionsRecyclerView(com.cvsu.ash.rhea.fishapp.MapsActivity.this, listPathText, fName, sName);
...
//                        func.showDialog(com.cvsu.ash.rhea.fishapp.MapsActivity.this, "", "Route not yet available.");
//                        fab.setVisibility(View.GONE);
//                    } else {
//                        GlobalFunction func = new GlobalFunction();
//                        func.showDialog(com.cvsu.ash.rhea.fishapp.MapsActivity.this, "", "Oops. Something went wrong.");
//                        fab.setVisibility(View.GONE);
//                    }
//
//                }
